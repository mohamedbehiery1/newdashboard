...
import { Button, ButtonGroup, Typography, Box, Hidden, IconButton } from '@material-ui/core';
  ...
  const Navigation = (orientation, handleClick) => (
    <>
      <ButtonGroup {...orientation} sx={{ alignItems: 'center', flex: 1, justifyContent: 'center', }} variant="standard" >
        ...
        {/* <Button onClick={_ => { if (!isCollapsed) collapseMenu() }} disableTouchRipple className={muiClasses.button} sx={{ color: 'white.main' }} component={Link} to='/auth/driver' py={0}>
          {t("Partners")}
        </Button> */}
      </ButtonGroup>
  ...
  return (
    <header
      ...
      style={{
        ...
        boxShadow: '0 0.5px 24px rgb(0 89 140 / 100%)'
      }}
    >
      <Box
        className="container"
