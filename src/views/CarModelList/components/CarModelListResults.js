...
const CarModelListResults = ({ 
  ...
  const columns = [
    ...
    { field: "carBrand", headerName: t("Car Brand"), width: $COLUMN_WIDTH * 1.1, valueGetter: (params) =>{ return params.row.carBrand.name } ,renderCell },
    { field: "carOrigin", headerName: t("Car Origin"), width: $COLUMN_WIDTH * 1.1, valueGetter: (params) =>{ return params.row.carBrand.carOrigin.name } ,renderCell },
...
CarModelListResults.propTypes = {
  carModels: PropTypes.array.isRequired,
};

export default CarModelListResults;
